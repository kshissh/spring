...
public class NotificationAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public NotificationAvro(java.lang.CharSequence event, java.lang.CharSequence id) {
    this.event = event;
    this.id = id;
  }
   ...
   */
  public static NotificationAvro.Builder newBuilder() {
    return new NotificationAvro.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static NotificationAvro.Builder newBuilder(NotificationAvro.Builder other) {
    return new NotificationAvro.Builder(other);
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static NotificationAvro.Builder newBuilder(NotificationAvro other) {
    return new NotificationAvro.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NotificationAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(NotificationAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(NotificationAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.event)) {
        this.event = data().deepCopy(fields()[0].schema(), other.event);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public NotificationAvro.Builder setEvent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NotificationAvro.Builder clearEvent() {
      event = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public NotificationAvro.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public NotificationAvro.Builder clearId() {
      id = null;
