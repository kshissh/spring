...
public class KafkaConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Object>> kafkaListenerContainerFactory(DefaultKafkaConsumerFactory<String, Object> consumerFactory) {
