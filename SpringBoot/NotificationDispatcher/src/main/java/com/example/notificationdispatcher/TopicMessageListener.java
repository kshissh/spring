...
@Component
public class TopicMessageListener implements MessageListener<String, NotificationAvro> {
    ...
    public TopicMessageListener(SubscriptionRepository subscriptionRepository, Mapper mapper, ScheduledExecutorConfig executorService) {
