...
public class Subscription extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public Transport transport;
   ...
   */
  public Subscription(java.lang.CharSequence subscriptionId, java.lang.CharSequence createdAt, java.lang.CharSequence expiresAt, java.lang.CharSequence status, java.lang.CharSequence family, Transport transport) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: transport = (Transport)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new Subscription RecordBuilder
   */
  public static Subscription.Builder newBuilder(Subscription.Builder other) {
    return new Subscription.Builder(other);
  }
   ...
   * @return A new Subscription RecordBuilder
   */
  public static Subscription.Builder newBuilder(Subscription other) {
    return new Subscription.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Subscription>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Subscription.Builder other) {
      super(other);
      ...
      if (other.hasTransportBuilder()) {
        this.transportBuilder = Transport.newBuilder(other.getTransportBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Subscription other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.subscriptionId)) {
        this.subscriptionId = data().deepCopy(fields()[0].schema(), other.subscriptionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder setSubscriptionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder clearSubscriptionId() {
      subscriptionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder setCreatedAt(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder clearCreatedAt() {
      createdAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder setExpiresAt(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder clearExpiresAt() {
      expiresAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder setFamily(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder clearFamily() {
      family = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder setTransport(Transport value) {
    ...
    public Transport.Builder getTransportBuilder() {
      if (transportBuilder == null) {
        if (hasTransport()) {
          setTransportBuilder(Transport.newBuilder(transport));
        } else {
          setTransportBuilder(Transport.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public Subscription.Builder setTransportBuilder(Transport.Builder value) {
      clearTransport();
    ...
    /**
      ...
      * @return This builder.
      */
    public Subscription.Builder clearTransport() {
      transport = null;
    ...
    public Subscription build() {
      try {
        ...
        if (transportBuilder != null) {
          ...
          record.transport = fieldSetFlags()[5] ? this.transport : (Transport) defaultValue(fields()[5]);
        }
        return record;
