...
public class KafkaService {
    ...
    private KafkaTemplate<String, String> kafkaTemplate; //there should be SubscriptionAvro as a value
    private Mapper mapper;

    public KafkaService(KafkaTemplate<String, String> kafkaTemplate, Mapper mapper) {
    ...
    public void sendMessage(Subscription subscription){
        ...
        kafkaTemplate.send("notification-subscription", message.toString());
